...
extern int StartMonth = 12;
extern int EndYear = 2018;
...
int start() {
   ...
   for (g_pos_180 = 0; g_pos_180 < OrdersTotal(); g_pos_180++) {
      ...
      if (OrderSymbol() == Symbol()) g_count_176++;
   }
   if (g_count_176 < 1) {
   ...
   if (Symbol() == "USDJPY") gd_300 = USDJPYPipValue;
      ...
      if (Bid - g_ord_open_price_248 >= Pips * setpoint() || g_count_176 < 1) {
         ...
         if (g_count_176 != 0) {
            ...
            for (g_pos_180 = 1; g_pos_180 <= g_count_176; g_pos_180++) {
               if (MaxTrades > 12) g_lots_228 = NormalizeDouble(1.5 * g_lots_228, 1);
               else g_lots_228 = NormalizeDouble(2.0 * g_lots_228, 1);
            }
         } else g_lots_228 = gd_220;
         if (g_lots_228 > 100.0) g_lots_228 = 100;
         OrderSend(Symbol(), OP_SELL, g_lots_228, g_bid_212, g_slippage_184, g_price_188, g_price_196, 0, Magic, 0, clrBlue);
         return (0);
      }
   }
   if (gi_240 == 2 && gi_244) {
      if (g_ord_open_price_248 - Ask >= Pips * setpoint() || g_count_176 < 1) {
         ...
         if (g_lots_228 > 100.0) g_lots_228 = 100;
         OrderSend(Symbol(), OP_BUY, g_lots_228, g_ask_204, g_slippage_184, g_price_188, g_price_196, 0, Magic, 0, clrRed);
         return (0);
      }
   }
   return (0);
