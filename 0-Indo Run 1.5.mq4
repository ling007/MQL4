...
extern int Magic = 2018;            //Order Magic Number
...
extern string TSD_Calendar_URL = "https://www.mql5.com/en/economic-calendar?utm_campaign=redirect&utm_source=calendar.forex-tsd.com";
//extern string TSD_Calendar_URL = "http://calendar.forex-tsd.com/calendar.php?csv=1&date=";////https://www.mql5.com/en/economic-calendar?utm_campaign=redirect&utm_source=calendar.forex-tsd.com
    ...
    while(boolTerm==false)
      {
       if(OrderSelect(POS,SELECT_BY_POS))
         {
         if(OrderMagicNumber()==Magic) dblProfit=dblProfit+OrderProfit()+OrderCommission()+OrderSwap();
         POS++;
         }
        else
        boolTerm=true;
